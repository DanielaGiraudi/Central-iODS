...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[OpsDB_Production_Data_PM]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[OpsDB_Production_Data_PM] (
...
CONSTRAINT [FK_OpsDB_Production_Data_PM_LINE_DIMENSION]
	FOREIGN KEY ([LINE_DIMENSION_CentralLineId])
	REFERENCES [dbo].[LINE_DIMENSION] ([CentralLineId]),
CONSTRAINT [FK_OpsDB_Production_Data_PM_SITE_DIMENSION]
	FOREIGN KEY ([SITE_DIMENSION_SiteId])
	REFERENCES [dbo].[SITE_DIMENSION] ([SiteId]),
CONSTRAINT [PK_OpsDB_Production_Data_PM]
	PRIMARY KEY NONCLUSTERED ([CentralRcdIdx] ASC))
END
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[OpsDB_Production_Data_PM]') AND name = N'IDX_UQ_OpsDB_Production_Data_PM_SiteId_RcdIdx')
	CREATE UNIQUE NONCLUSTERED INDEX [IDX_UQ_OpsDB_Production_Data_PM_SiteId_RcdIdx] ON [dbo].[OpsDB_Production_Data_PM]
